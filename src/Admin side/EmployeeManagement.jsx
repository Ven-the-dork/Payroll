    ...
    <div className="flex min-h-screen bg-gray-100">
      ...
      <main className="flex-1 p-8 overflow-x-hidden">
        ...
        <div className="relative">
          ...
          {/* Profile view */}
          <div
            className={`transition-transform duration-500 ${profileOpen ? "translate-x-0 opacity-100 relative" : "translate-x-full opacity-0 pointer-events-none absolute inset-0"
              }`}
          >
